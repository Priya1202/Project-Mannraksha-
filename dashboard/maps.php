...
<!--market updates updates-->
	<div class="map-main-page">  	
    	<h2>Maps</h2>
		<br><br><h4>visualization Through Maps</h4>
		<br><img src="images\Frame2.png" style="width:800px;height:1000px;"</img>
...
<div class="sidebar-menu">
  ...
  <div class="menu">
	<ul id="menu" >
	  ...
	  <li><a href="ml.html"><i class="fa fa-cogs"></i><span>ML Model</span></span></a></li>
	  </li>
